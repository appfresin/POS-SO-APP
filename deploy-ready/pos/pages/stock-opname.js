...
const STOCK_OPNAME_QR_URL = "https://fresinapp.vercel.app/pos/#stock-opname";
...
function stockOpnameQrImageUrl() {
  return `https://api.qrserver.com/v1/create-qr-code/?size=260x260&margin=12&data=${encodeURIComponent(STOCK_OPNAME_QR_URL)}`;
}
  ...
  openModal(`
    <div class="stock-opname-qr-modal">
      <div class="modal-form-head stock-opname-qr-head">
        <div>
          <h3>QR Stok Opname</h3>
          <p>Scan untuk membuka halaman stok opname.</p>
        </div>
      ...
      <div class="stock-opname-qr-box">
        <img src="${escapeHtml(stockOpnameQrImageUrl())}" alt="QR Code Stok Opname" loading="lazy" />
      </div>
